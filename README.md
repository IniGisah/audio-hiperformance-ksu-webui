...
5. **Direct Low-Jitter Audio Pass**:
   - Disables system-wide audio effects framework (`ro.audio.ignore_effects=true`), spatializers (`ro.audio.spatializer_enabled=false`), and compression limiters (`soundfx`) to achieve a pure, untouched audio pass to your DAC.
